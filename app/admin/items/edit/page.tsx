          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select name="category" defaultValue={item.category ?? "loot"} className="mt-1 h-9 w-full rounded-md border px-2 text-sm">
            ...
            <div>
              ...
              <select name="carry_behavior" defaultValue={item.carry_behavior ?? "loose"} className="mt-1 h-9 w-full rounded-md border px-2 text-sm">
            ...
            <div className="md:col-span-2">
              ...
              <textarea name="rules_text" defaultValue={item.rules_text ?? ""} className="mt-1 min-h-[90px] w-full rounded-md border p-3 text-sm" />
            </div>

            <div className="md:col-span-2">
              <label className="text-xs text-muted-foreground">Image URL</label>
              <input name="image_url" defaultValue={item.image_url ?? ""} className="mt-1 h-9 w-full rounded-md border px-3 text-sm" />
            </div>
          </div>
          ...
          <div className="mt-4 rounded-xl border p-3">
            ...
            <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-3">
              <div>
                ...
                <select name="weapon_kind" defaultValue={item.weapon_kind ?? ""} className="mt-1 h-9 w-full rounded-md border px-2 text-sm">
                  <option value="">—</option>
              ...
              <div>
                ...
                <input name="damage_dice" defaultValue={item.damage_dice ?? ""} placeholder="1d8" className="mt-1 h-9 w-full rounded-md border px-3 text-sm" />
              </div>

              <div>
                <label className="text-xs text-muted-foreground">damage_bonus</label>
                <input name="damage_bonus" type="number" step="1" defaultValue={item.damage_bonus ?? ""} className="mt-1 h-9 w-full rounded-md border px-3 text-sm" />
              </div>

              <div>
                <label className="text-xs text-muted-foreground">damage_type</label>
                <input name="damage_type" defaultValue={item.damage_type ?? ""} placeholder="slashing" className="mt-1 h-9 w-full rounded-md border px-3 text-sm" />
              </div>

              <div>
                <label className="text-xs text-muted-foreground">range_normal</label>
                <input name="range_normal" type="number" step="1" defaultValue={item.range_normal ?? ""} className="mt-1 h-9 w-full rounded-md border px-3 text-sm" />
              </div>

              <div>
                <label className="text-xs text-muted-foreground">range_max</label>
                <input name="range_max" type="number" step="1" defaultValue={item.range_max ?? ""} className="mt-1 h-9 w-full rounded-md border px-3 text-sm" />
              </div>
              ...
              <div>
                ...
                <input name="save_dc_override" type="number" step="1" defaultValue={item.save_dc_override ?? ""} className="mt-1 h-9 w-full rounded-md border px-3 text-sm" />
              </div>
