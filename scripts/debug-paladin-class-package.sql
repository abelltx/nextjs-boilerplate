-- Debug script for the Paladin class-package item.
-- Open this file in VS Code, replace YOUR_CHARACTER_ID everywhere, then run each query in Supabase SQL editor.
...
with params as (
  select
    ...
    '59d0fb62-e201-4be9-b603-17cd53d503a5'::uuid as class_item_id
)
select
  i.id as item_id,
  i.name as item_name,
...
-- character_stats_current is what the player page prefers.
-- =========================================================
...
-- =========================================================
-- 4) Compare specific key fields side by side
-- =========================================================
